...
Write-Host "==> Phase 14.5 repaired portfolio engine smoke run"
...
Write-Host "==> Phase 14 research intelligence against repaired smoke output"
...
python -m pytest
Write-Host "Phase 14.5 quality gate passed."
