...
Invoke-Step "Phase 11.2.2 label intelligence smoke run" 'python .\scripts\phase11_label_intelligence.py --dataset .\data\ml_dataset\phase11_smoke.parquet --output .\reports\phase11_label_intelligence_smoke --maximum-rows 10000 --minimum-horizon-rows 100'
Invoke-Step "Phase 11.3-11.9 model intelligence smoke run" 'python .\scripts\phase11_model_intelligence.py --dataset .\data\ml_dataset\phase11_smoke.parquet --label-signoff .\reports\phase11_label_intelligence_smoke\phase11_label_signoff.json --output .\reports\phase11_model_intelligence_smoke --maximum-rows-per-horizon 2000 --minimum-train-rows 500'
...
Write-Host "Phase 11.9 quality gate passed."
